...
# close the file...
fh.close()
print("Lines written to new file. Part 1 finished \n")
...
## Looks like values are seperated by spaces
##-----------
...
fh = open(res_path + fn, mode='r+')
line2 = fh.readline()

for line2 in fh:
    # print line
    sec_line = line2[0:]
    print("The second line from the file is =", sec_line)
